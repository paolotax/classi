...
class AdozioniControllerTest < ActionController::TestCase
  ...
  test "should create adozione" do
    assert_difference('Adozione.count') do
      post :create, adozione: { classe_id: @adozione.classe_id, libro_id: @adozione.libro_id, nr_copie: @adozione.nr_copie }
    end
  ...
  test "should update adozione" do
    put :update, id: @adozione, adozione: { classe_id: @adozione.classe_id, libro_id: @adozione.libro_id, nr_copie: @adozione.nr_copie }
    assert_redirected_to adozione_path(assigns(:adozione))
  end

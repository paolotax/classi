...
class ClassiControllerTest < ActionController::TestCase
  ...
  test "should create classe" do
    assert_difference('Classe.count') do
      post :create, classe: { classe: @classe.classe, cliente_id: @classe.cliente_id, nr_alunni: @classe.nr_alunni, sezione: @classe.sezione }
    end
  ...
  test "should update classe" do
    put :update, id: @classe, classe: { classe: @classe.classe, cliente_id: @classe.cliente_id, nr_alunni: @classe.nr_alunni, sezione: @classe.sezione }
    assert_redirected_to classe_path(assigns(:classe))
  end
